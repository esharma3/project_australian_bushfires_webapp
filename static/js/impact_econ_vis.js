...
var trace1 = {
    x: fireData.map(e => e.year).slice(1,68),
    y: fireData.map(e => e.acres_burned).slice(1,68),
    mode: 'markers',
    type: 'scatter',
    name: 'Acres Burned',
...
trace1 = {
    type: 'scatter',
    x: fireData.map(e => e.year).slice(1,68),
    y: fireData.map(e => e.homes_destroyed).slice(1,68),
    mode: 'lines',
...
trace2 = {
    type: 'scatter',
    x: fireData.map(e => e.year).slice(1,68),
    y: fireData.map(e => e.human_fatalities).slice(1,68),
    mode: 'lines',
